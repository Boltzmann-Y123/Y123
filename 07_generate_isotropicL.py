...
def show_fs_situation(index, *, ax='new', units='SI'):
    ...
    f.savefig('05 recent/_fs_with_L.png', dpi=400)
    f1.savefig('05 recent/_Lorb_inner_square.png', dpi=400)
    f2.savefig('05 recent/_Lorb_outer_square.png', dpi=400)
    f3.subplots_adjust(left=0.2, right=0.95)
    f3.savefig('05 recent/_Lorb_chain_square.png', dpi=400)
    return f, ax
...
def show_multipanel(index):
    ...
    f.savefig('05 recent/isotropic_L_result.png', dpi=400)
